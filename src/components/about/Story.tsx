...
function Story() {
    return ( 
      <section id="kim-jestesmy" className="scroll-mt-32 py-24 px-6 bg-radial from-(--color-deep-teal-dark) to-(--color-soft-charcoal)">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            >
              ...
              <div className="space-y-4 text-(--color-off-white)/70 font-montserrat leading-relaxed">
                <p>
                  Pod dyrekcją założycielki, <strong className="text-(--color-off-white)">prof. Sylwii Fabiańczyk-Makuch</strong>, 
                  istnieje na scenie muzycznej już ponad 20 lat. Zespół szybko stał się wizytówką miasta i regionu, 
                  szerząc morską tradycję w kraju i poza jego granicami.
                </p>
                <p>
                  Blisko stuosobowa grupa ma na swoim koncie setki koncertów, kilkanaście międzynarodowych 
                  tournée oraz kilkadziesiąt głównych nagród uzyskanych na prestiżowych festiwalach chóralnych 
