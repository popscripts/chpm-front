...
function ListCard({ icon, title, description, items }: ListCardProps) {
  ...
  return (
    <div className="p-8 w-full max-w-[85vw] mx-auto min-w-0 bg-[#00384d]/10 border border-[#F5F5F5]/10 hover:border-(--color-champagne-gold)/30 transition-all shadow-lg text-center h-full flex flex-col">
