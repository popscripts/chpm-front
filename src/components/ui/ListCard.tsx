...
function ListCard({ icon, title, description, items, index = 0 }: ListCardProps) {
  ...
  return (
    <motion.div
      ...
      className="p-8 w-full min-w-0 bg-[#00384d]/10 border border-[#F5F5F5]/10 hover:border-[#D4AF37]/30 transition-all shadow-lg text-center h-full flex flex-col"
    >
        <div className="w-16 h-16 bg-[#D4AF37]/10 flex items-center justify-center mx-auto mb-4">
        {icon}
        </div>
