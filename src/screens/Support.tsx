...
export default function Support() {
  ...
  const tierConfig = {
    ...
    mat_podchorazy: {
      ...
      label: t("tiers.matPodchorazy"),
    },
  };

  const reasons = [
    {
      title: t("why.cards.recordings.title"),
      description: t("why.cards.recordings.description"),
    },
    {
      title: t("why.cards.tours.title"),
      description: t("why.cards.tours.description"),
    },
    {
      title: t("why.cards.repertoire.title"),
      description: t("why.cards.repertoire.description"),
    },
  ];
