...
async function JoinUs() {
  ...
  const joinUsHighlights = [
    {
      title: t("highlights.rehearsals.title"),
      description: t("highlights.rehearsals.description"),
    },
    {
      title: t("highlights.stage.title"),
      description: t("highlights.stage.description"),
    },
    {
      title: t("highlights.ensemble.title"),
      description: t("highlights.ensemble.description"),
    },
  ];
