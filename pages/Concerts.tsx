...
const concerts = [
  {
    ...
    city: "Kraków",
    description:
      "Wieczór muzyki sakralnej i współczesnych kompozycji chóralnych.",
    image_url:
  ...
  },
  {
    ...
    city: "Warszawa",
    description:
      "Wspolny koncert z orkiestra kameralna. Repertuar: Pergolesi, Vivaldi.",
    image_url:
      "https://images.unsplash.com/photo-1485562569060-2eec283d3391?w=900&q=80",
  ...
  },
  {
    ...
    city: "Gdansk",
    description:
      "Podsumowanie roku artystycznego z udziałem gosci specjalnych.",
    image_url:
