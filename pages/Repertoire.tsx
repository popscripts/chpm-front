...
export default async function Repertoire() {
  ...
  const compositionsByLetter = compositions.reduce<Record<string, typeof compositions>>(
    (acc, composition) => {
      const firstLetter = composition.title.trim().charAt(0).toLocaleUpperCase("pl-PL");
